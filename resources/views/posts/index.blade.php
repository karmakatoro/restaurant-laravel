                ...
                <div class="w-full lg:w-8/12">
                    ...
                    <div class="mt-6">
                        <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                            ...
                            <div class="mt-2">
                                <a href="{{ route('posts.show', $post) }}" class="text-2xl font-bold text-gray-700 hover:underline">
                                    {{ $post->title }}
                                </a>
                            ...
                            <div class="flex items-center justify-between mt-4"><a href="{{ route('posts.show', $post) }}" class="text-blue-500 hover:underline">Voir plus</a>
                                <div>
                                    <a href="#" class="flex items-center">
                                        <img src="{{ asset('/storage/'.$post->image) }}" alt="avatar" class="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block">
