<x-app-layout>
    ...
    <div class="flex flex-col justify-between">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-10 ">
            ...
            @endif
            <form class="w-full max-w-lg" method="post" action="{{ route('posts.update', $post) }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input value="{{ $post->title }}" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="title" id="title" type="text" placeholder="Titre du post">
                        @if($errors->has('title'))
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <button type="submit" class="appearance-none block w-full bg-indigo-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white">Modifier</button>
                    </div>
                </div>
            </form>
        </div>
